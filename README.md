...
A **two-piece cable clamp** is also available. It uses an open cradle integrated into the holder plus a separately printed U-shaped retaining clip. Insert the cable first, then press the clip over the cradle. The retaining clip is included as a separate body in the exported STL.
...
- **Brodit ball joint – 3-hole vertical mounting pattern**, with the centre hole automatically 2 mm larger than the upper and lower holes
...
The **Minimalist** holder option is an original parametric implementation inspired by **“Brodit Holder for Samsung A6 and A70” by L00TW1CK**:

https://www.thingiverse.com/thing:4774148

The referenced model is listed on Thingiverse under **Creative Commons Attribution**. The generator does not include or redistribute the original mesh; the Minimalist option is generated parametrically from the selected phone dimensions.
